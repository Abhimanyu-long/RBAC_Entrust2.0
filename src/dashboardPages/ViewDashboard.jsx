...
import CaseCalender from "./../dashboardPages/CaseCalender";
    ...
    const statusData = validCaseData.map((item) => ({
      ...
      color:
        item.case_status === "Delivered"
          ...
          ? "#ffc107" // Yellow
          : item.case_status === "Awaiting Funds"
          ? "#38a5ff"
      ...
      if (action_details) {
        ...
        if (details.action_details?.additional_data?.status) {
          ...
          if (navigatorlink.status === 13) {
            navigate(
              `/allclients/client/${navigatorlink.client_id}/case/${navigatorlink.case_id}`
            );
          }
        ...
        >
          <div className="row" style={{ background: "f9fcfe" }}>
              ...
              >
                {isCaseDataLoading ? (
                  ...
                  <>
                    ...
                    <div
                      className="card-body d-flex flex-column justify-content-end pt-0 mt-0"
                      style={{ padding: "10px" }}
                    >
                              ...
                              {projectData
                                ...
                                .map((entry, index) => (
                                  <Cell
                                    ...
                                    onClick={() =>
                                      handleProjectClick(entry.project_id)
                                    }
                                    style={{ cursor: "pointer" }}
                                  />
                                ))}
                      ...
                      <div className="w-100 px-3">
                        <div className="d-flex align-items-center justify-content-between py-2">
                          ...
                          <span className="fw-bold text-gray-700">
                            {currencySymbol}
                            {/* {isallocated.amount} */}
                            {Number(isallocated?.amount).toLocaleString(
                              "en-US"
                            )}
                          </span>
                        </div>
                          ...
                          <div className="row w-100">
                            ...
                            <div className="col-12 mb-2">
                              <button
                                ...
                                onClick={() =>
                                  handleDownloadFile(
                                    "/neuralit/web/apps/openatrium-6.x-1.7/sites/default/files/RATE_CHART.pdf",
                                    null,
                                    "download_rate_chart"
                                  )
                                }
                      ...
                      <div className="d-flex flex-column align-items-center ">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          >
                            ...
                            {autopay?.Minimum_Balance_Required !== undefined
                              ? autopay.Minimum_Balance_Required
                              : "0"}{" "}
                            {/* Ensure fallback */}
                          </p>
                        </div>
            ...
            <div className="col-12 col-md-12 col-lg-6">
              {/* Action Needed */}
              <div
                className="card card-flush mb-3 mb-xl-2 auto-swipe-active action-needed"
                style={{
                  maxHeight: "90vh",
                  minHeight: "335px",
                  display: "flex",
                        ...
                        data.map((image, index) => (
                          <Carousel.Item key={image.id} className="h-100">
                            <a
                              ...
                              className="d-block h-100 w-100 position-relative"
                            >
                              <img
