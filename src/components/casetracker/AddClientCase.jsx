    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      for (const field in newErrors) {
        if (newErrors.hasOwnProperty(field)) {
          // Check which field has the error and scroll to that section
          if (field === "title") {
            titleRef.current.scrollIntoView({ behavior: "smooth", block: "start" });
            break;
          } else if (field === "subtitle") {
            caseInfoRef.current.scrollIntoView({ behavior: "smooth", block: "start" });
            break;
          } else if (field === "body") {
  ...
  useEffect(() => {
    ...
    if (userRole) {
      if (
        ...
        userRole === "Client Case Manager" ||
        userRole === "Client Finance Manager" ||
