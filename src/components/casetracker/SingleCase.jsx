...
export const SingleCase = () => {
  ...
  return loading ? ( // Show Loader when loading is true
    <Loader />
  ) : (
    <>
                            ...
                            <tbody>
                              {detailCase.files.map((file) => (
                                <tr key={file.file_id}>
                                  ...
                                  <td>{formatTimestamp(file.uploaded_on)}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
                                ...
                                <>
                                  ...
                                  <div className="d-flex justify-content-between align-items-center mb-0 mt-0">
                                    {comment.reply_to !== null &&
                                      ...
                                      (() => {
                                        const replyDetails = findReplyCommentId(
                                          comment.reply_to,
                                          comments
                                        );
                                        return replyDetails ? (
                                  ...
                                  {replyingCommentId === comment.comment_id && (
                                    <div className="reply-form mt-3 p-3 border rounded">
                                      <h6 className="fw-bold required">
                                        Reply to Comment #{comment.sr_number}
                                      </h6>
                                      ...
                                      <div className="form-group ">
                                        ...
                                        {replySelectedFiles[
                                          ...
                                          replySelectedFiles[comment.comment_id]
                                            .length > 0 && (
                                            <>
                                              {renderReplyFileList(
                                                comment.comment_id
